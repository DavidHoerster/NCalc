...
namespace NCalc
{
    public class Numbers
    {
        ...
        public static object Sum(params object[] inputs)
        {
            ...
            {
                if (inputs[i] is System.Collections.IEnumerable)
                {
                    var inputArray = ((System.Collections.IEnumerable)inputs[i]);
                    var inputArrayEnumerator = inputArray.GetEnumerator();
                    while (inputArrayEnumerator.MoveNext())
                    {
                        sum = Add(sum, inputArrayEnumerator.Current);
                    }
                }
